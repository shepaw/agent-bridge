...
export const en = {
  ...
  'detail.sessionsHint': 'View transcripts and chat with the agent from this dashboard.',
  ...
  'sessions.composerHint': 'Enter to send · Shift+Enter for newline · Attachments go to the pouch · Tool calls are auto-approved',
  'sessions.attachFile': 'Upload to pouch',
  'sessions.attachStore': 'Reference pouch file',
  'sessions.attachNoStore': 'This agent has no pouch mapping yet.',
  'sessions.attachUploading': 'Uploading…',
  'sessions.attachTooBig': 'File is too large (max about 5MB).',
  'sessions.attachFailed': 'Could not store the file: {error}',
  'sessions.attachRemove': 'Remove {name}',
  'sessions.pickerTitle': 'Choose from Nexus Pouch',
  'sessions.pickerHint': 'Pick files already in the pouch. They stay where they are — the chat only references them.',
  'sessions.pickerEmpty': 'This folder is empty.',
  'sessions.pickerConfirm': 'Add {count} file',
  'sessions.pickerConfirmPlural': 'Add {count} files',
  'sessions.pickerRootAgent': 'Agent pouch',
  'sessions.pickerRootWorkspace': 'Workspace',
  'sessions.pickerRootFiles': 'Local files',
  'sessions.count': '{count} session',
  'sessions.countPlural': '{count} sessions',
  'sessions.manage': 'Manage mappings',
  'sessions.none': 'No sessions yet. Start a chat here or from the Shepaw app.',
  ...
  'sessions.selectPrompt': 'Select a session, or send a message to start a new chat.',
  'sessions.loadingHistory': 'Loading history… This may take up to 40 seconds.',
  'sessions.noHistory': 'No history yet. Send a message to start this conversation.',
  'sessions.newChat': 'New chat',
  'sessions.draftTitle': 'New chat',
  'sessions.composerPlaceholder': 'Message the agent…',
  'sessions.mode': 'Mode',
  'sessions.model': 'Model',
  'sessions.modeFailed': 'Could not switch mode: {error}',
  'sessions.modelFailed': 'Could not switch model: {error}',
  'sessions.send': 'Send',
